 ...
 *
 * @_description Copies individual files or entire directories to the build directory.
 *
...
//  *
//  * @_description The plugin replaces the default resource.
//  *
...
//  * Plugin: DefinePlugin
//  *
//  * @_description The DefinePlugin allows you to create global constants which can be configured at compile time.
//  *
 ...
 * Plugin: webpackMerge
 *
 * @_description Provides a merge function that concatenates arrays and merges objects
 *
 ...
 *
 * @_description considers all modules under the local node_modules/ directory as externals.
 *
 */
 ...
 *
 * @_description Extract text from bundle into a file.
 */
 ...
 *
 * @_description Plugin to replace a standard webpack chunkhash with md5
 *
